        ...
        <div className="navbar-container">
            ...
            {isMenuOpen && (
                <div className='mobile-menu'>
                    ...
                    <Link to="/challenges" className='navbar-link' onClick={toggleMenu}>Challenges</Link>
                    <Link to="/login" className='navbar-link' onClick={toggleMenu}>Login</Link>
                    <Link to="/signup" className='navbar-link navbar-signup' onClick={toggleMenu}>Sign Up</Link>
                </div>
            )}
        </div>
    );
